...
runtime checks covering menus, dialogue rendering and ending scenes. Loading an
existing save was also verified manually.
...
- French translation v0.7: **Brutapode89**, used as a technical reference for
  the text and font structure
