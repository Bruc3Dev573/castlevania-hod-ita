...
runtime mirate su menu, dialoghi e scene finali. Il caricamento di un
salvataggio esistente è stato verificato manualmente.
...
- Traduzione francese v0.7: **Brutapode89**, usata come riferimento tecnico
  per la struttura del testo e del font
